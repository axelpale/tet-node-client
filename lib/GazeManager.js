...
var GazeManager = function () {
  ...
  var onGazeApiResponse = function (message) {
  ...
  this.activate = function (options, onConnectionStateChanged) {
    ...
    if (!this.isActivated()) {
      ...
      apiManager.connect(options.hostname, options.portnumber, function () {
        apiManager.requestSetTracker(options.clientMode, options.version);
